...
public class PathMaker : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        for (int i = 0; i < path.Length; i++)
        {
            ...
            {
                mg.generateTriangle(prevShape[j], currentShape[j], currentShape[j + 1] , 0);
                mg.generateTriangle(prevShape[j + 1], prevShape[j], currentShape[j+1], 0);
            }
        ...
        meshFilter.mesh = mg.generateMesh();
    }
