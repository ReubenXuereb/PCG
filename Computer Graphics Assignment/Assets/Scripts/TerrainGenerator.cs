...
public class TerrainGenerator : MonoBehaviour
{
    ...
    void generateWater()
    {
        ...
        waterGameObject.transform.localScale = new Vector3(2499.32715f, 1, 2513.42944f);
    }
    ...
    void generateClouds()
    {
        ...
        if (!cloudGameObject)
        {
            for (int i = 0; i <= 100; i++)
            {
                ...
                cloudGameObject.transform.position = new Vector3(Random.Range(0, 5000), 1390, Random.Range(0, 5000));
